    ...
    string? UndoUntilUtc = null)
{
    public static AppointmentDto From(Appointment a) => new(
        ...
        a.Source, a.PriceMinor, a.CurrencyCode, a.VisitId,
        a.HoldExpiresUtc?.ToUniversalTime().ToString("O"),
        a.CheckedInUtc?.ToUniversalTime().ToString("O"));
}
...
public sealed record CreateAppointmentRequest(
    ...
    string? Source = null, int? HoldMinutes = null, string? VisitId = null, bool? GuestRequestedProvider = null);
